...
const ICCPage = () => {
  ...
  const yearlyReports = [
    { year: "2024", title: "ICC Annual Compliance Report", size: "1.8 MB" },
    { year: "2023", title: "Gender Sensitization Program Report", size: "2.2 MB" },
    { year: "2022", title: "Complaint Resolution Statistics", size: "1.5 MB" }
  ];
